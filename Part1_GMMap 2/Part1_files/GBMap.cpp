...
int GBMap::getNumberOfPlayers()
{
	return numberOfPlayers;
}

void GBMap::setNumberOfPlayers(int Players)
{
	numberOfPlayers = Players;
}

void GBMap::createMap(int players)
{
	this->boardMap;
	...
	if (players == 4) {
		...
		tile9->setTop(tile3);
		tile9->setLeft(tile8);
		tile9->setRight(tile10);
		tile9->setBottom(tile16);
		...
		tile21->setLeft(tile20);
		tile21->setRight(tile22);
		tile21->setBottom(tile28);
